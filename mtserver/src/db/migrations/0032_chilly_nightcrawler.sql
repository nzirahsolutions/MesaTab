...
CREATE TABLE "tabs_sb" (
	...
	"title" text NOT NULL,
	"slug" text NOT NULL,
	"track" text DEFAULT 'Spelling Bee' NOT NULL,
...
CREATE TABLE "rounds_sb" (
	...
	CONSTRAINT "rounds_sb_tab_id_cup_category_id_number_unique" UNIQUE("tab_id","cup_category_id","number"),
	CONSTRAINT "rounds_sb_tab_id_break_phase_cup_category_id_unique" UNIQUE("tab_id","break_phase","cup_category_id"),
...
--> statement-breakpoint
CREATE TABLE "cup_categories_sb" (
	...
	CONSTRAINT "cup_categories_sb_tab_id_cup_order_unique" UNIQUE("tab_id","cup_order")
);
--> statement-breakpoint
...
CREATE TABLE "tabs_wsdc" (
	...
	"title" text NOT NULL,
	"slug" text NOT NULL,
	"track" text DEFAULT 'WSDC Debate' NOT NULL,
	"event_id" uuid NOT NULL,
...
CREATE TABLE "tabs_chess" (
	...
	"title" text NOT NULL,
	"slug" text NOT NULL,
	"track" text DEFAULT 'Chess' NOT NULL,
	"event_id" uuid NOT NULL,
...
CREATE TABLE "tabs_ps" (
	...
	"title" text NOT NULL,
	"slug" text NOT NULL,
	"track" text DEFAULT 'Public Speaking' NOT NULL,
	"event_id" uuid NOT NULL,
	"completed" boolean DEFAULT false NOT NULL,
	"min_score" integer DEFAULT 30 NOT NULL,
	"max_score" integer DEFAULT 90 NOT NULL,
	CONSTRAINT "tabs_ps_event_id_slug_unique" UNIQUE("event_id","slug"),
	CONSTRAINT "tabs_ps_score_range_chk" CHECK ("tabs_ps"."min_score" >= 0 AND "tabs_ps"."max_score" >= "tabs_ps"."min_score")
);
--> statement-breakpoint
...
CREATE TABLE "tabs_bp" (
	...
	"title" text NOT NULL,
	"slug" text NOT NULL,
	"track" text DEFAULT 'BP Debate' NOT NULL,
	"event_id" uuid NOT NULL,
...
ALTER TABLE "rounds_sb" ADD CONSTRAINT "rounds_sb_cup_category_id_cup_categories_sb_cup_category_id_fk" FOREIGN KEY ("cup_category_id") REFERENCES "public"."cup_categories_sb"("cup_category_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "cup_categories_sb" ADD CONSTRAINT "cup_categories_sb_tab_id_tabs_sb_tab_id_fk" FOREIGN KEY ("tab_id") REFERENCES "public"."tabs_sb"("tab_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "tabs_sb_eventId_idx" ON "tabs_sb" USING btree ("event_id");--> statement-breakpoint
CREATE INDEX "rounds_tabId_idx" ON "rounds_sb" USING btree ("tab_id");--> statement-breakpoint
CREATE INDEX "rounds_tab_number_idx" ON "rounds_sb" USING btree ("tab_id","number");--> statement-breakpoint
CREATE INDEX "cups_tabId_idx" ON "cup_categories_sb" USING btree ("tab_id");--> statement-breakpoint
...
CREATE INDEX "tab_masters_sb_institutionId_idx" ON "tab_masters_sb" USING btree ("institution_id");--> statement-breakpoint
...
CREATE INDEX "dj_draw_id_idx" ON "draw_judges_sb" USING btree ("draw_id");--> statement-breakpoint
...
CREATE INDEX "words_sb_tabId_idx" ON "words_sb" USING btree ("tab_id");--> statement-breakpoint
...
CREATE INDEX "tabs_bp_eventId_idx" ON "tabs_bp" USING btree ("event_id");